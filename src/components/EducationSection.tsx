          ...
          <motion.div variants={item} className="p-10 neo-box relative group overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              <div className="flex gap-4 items-start p-6 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transition-colors neo-box group/card">
                <div className="mt-1 shrink-0 bg-background text-foreground border-2 border-foreground p-3 group-hover/card:border-accent-foreground">
                  <BookOpen size={20} className="text-accent group-hover/card:text-accent" />
                </div>
                <div>
                  <h4 className="font-bold mb-2 text-lg tracking-tight neo-text group-hover/card:text-accent-foreground">Coursework</h4>
                  <p className="font-medium text-sm leading-relaxed group-hover/card:text-accent-foreground">
              ...
              <div className="flex gap-4 items-start p-6 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transition-colors neo-box group/card2">
                <div className="mt-1 shrink-0 bg-background text-foreground border-2 border-foreground p-3 group-hover/card2:border-accent-foreground">
                  <Shield size={20} className="text-accent group-hover/card2:text-accent" />
                </div>
                <div>
                  <h4 className="font-bold mb-2 text-lg tracking-tight neo-text group-hover/card2:text-accent-foreground">Specialized Studies</h4>
                  <p className="font-medium text-sm leading-relaxed group-hover/card2:text-accent-foreground">
